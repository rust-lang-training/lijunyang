...
module.exports = require('@neon-rs/load').proxy({
  platforms: {
    'win32-x64-msvc': () => require('@day05_03/win32-x64-msvc'),
    'darwin-x64': () => require('@day05_03/darwin-x64'),
    'darwin-arm64': () => require('@day05_03/darwin-arm64'),
    'linux-x64-gnu': () => require('@day05_03/linux-x64-gnu')
  },
