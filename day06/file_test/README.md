...
Building file_test requires a [supported version of Node and Rust](https://github.com/neon-bindings/neon#platform-support).
...
After building file_test, you can explore its exports at the Node console:
