...
function __wbg_adapter_16(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc1fae189ff184c05(arg0, arg1, addHeapObject(arg2));
}

/**
* @param {InputEvent} event
*/
export function handle_convert(event) {
    wasm.handle_convert(addHeapObject(event));
}

/**
* @param {MouseEvent} _event
*/
export function handle_reset(_event) {
    wasm.handle_reset(addHeapObject(_event));
}

/**
*/
export function bind_event() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.bind_event(retptr);
...
/**
*/
export function gen_elements() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.gen_elements(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('hw2_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
